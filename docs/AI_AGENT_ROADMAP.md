...
> 작성일: 2026-04-30
> 1차 구현 상태: 회의 녹음 업로드, 서버 저장, OpenAI 전사, 회의자료 초안 생성/검토/적용, 회의 할 일 업무 전환, 읽기 전용 AI Assistant와 최근 요청 기록까지 완료.
...
- OpenAI 토큰/비용 사용량 감사 로그
- 회의/프로젝트/팀 등 질의 범위 선택
...
이후 담당자 자동 매칭과 생성 업무 카카오 공유를 붙인다.
